...
<div class="p-4 sm:ml-64">
   <div class="p-4  rounded-lg dark:border-gray-700">
     <div class="foodlist mb-5">
        <h1 class="text-3xl font-extrabold">Order Food List</h1>
     </div>
...
<?php
 ...
 ?>
                                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                            ...
                                            <td class="px-6 py-4">
                                                <a href="../php/adminDelOrder.php?del=<?php echo $foodIdOr; ?>" class="font-medium bg-blue-700 p-4 rounded-lg text-white dark:text-white hover:underline">Delete</a>
                                            </td>
                                        </tr>
<?php
 }

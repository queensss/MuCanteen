...
<div class="p-4 sm:ml-64">
   <div class="p-4  rounded-lg dark:border-gray-700">
     <div class="foodlist mb-5">
        <h1 class="text-3xl font-extrabold">Customer List</h1>
     </div>
       <div class="food-list">
    ...
    ?>
                                        ...
                                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                         <td class="px-6 py-4 font-semibold text-gray-900 dark:text-white">
                                            ...
                                            <td class="px-6 py-4">
                                                <a href="../php/delCustomer.php?del=<?php echo $id; ?>" class="font-medium bg-red-700 p-4 rounded-lg text-white dark:text-white hover:underline">Delete</a>
                                            </td>
                                        </tr>
<?php
        }

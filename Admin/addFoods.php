   ...
   <div class="foods">
               <div class="add-foods">
                  <div class="title bg-blue-900 mb-5 p-5 rounded-lg shadow-2xl">
                     ...
                     <h1 class="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl">Add foods</h1>
                  </div>
                  <div class="succes-form bg-white-50 p-5 rounded-lg shadow-2xl">
                     ...
                     <?php
                      ...
                      if(isset($_POST["foodname"]) && isset($_FILES["photo"]) && isset($_POST["tk"])){
                        ...
                        $dataSet = "INSERT INTO `foods`(`foodName`, `photo`, `tk`) VALUES ('$foodname','$photoName',' $tk')";
                     ...
                     ?>
                     <form class="mx-auto" action="addFoods.php" method="POST" enctype="multipart/form-data"> 
                        <label for="title" class="block mb-2 text-lg font-medium text-gray-900 dark:text-black">Foods Name:  </label>
                        <input type="text" id="title" name="foodname"  class="rounded-lg bg-gray-50 border border-gray-300 text-gray-900 w-full focus:ring-blue-500 p-2.5" placeholder="food name" requied>
                        ...
                        <label for="des" class="block mb-2 mt-5 text-lg font-medium text-gray-900 dark:text-black">Taka: </label>
                        <input type="text" id="tk" name="tk"  class="rounded-lg bg-gray-50 border border-gray-300 text-gray-900 w-full focus:ring-blue-500 p-2.5" placeholder="food price " required>

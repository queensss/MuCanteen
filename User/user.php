      ...
      <div class="grid grid-cols-3 gap-4 mb-4">
         <div class="flex items-center justify-center h-24 rounded bg-gray-50 dark:bg-gray-800">
            <div class="food flex items-center justify-around">
                <h1 class="text-2xl font-extrabold text-white">Total Food Items: </h1>
                <h1 class="text-2xl m-1 font-extrabold text-white"> 20</h1>
            </div>
...
<!-- this is food list sectoin -->
       <!-- this is food order section -->
       <?php require_once("foods.php") ?>
       <!-- this is food order section -->
   </div>
</div>

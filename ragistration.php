...
<div class="login-form mt-40 ">   
    <form class="max-w-sm mx-auto shadow-lg rounded-lg p-5" action="php/userSignUp.php" method="POST">
        <div class="login mb-5">
            <h1>Sign Up.</h1>
        </div>
        <div class="mb-5">
            <label for="text" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Your Full Name:</label>
            <input type="text" id="text" name="fullname" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="full name" required />
        </div>
        <div class="mb-5">
     ...
     <div class="flex items-start mb-5">
        ...
        <div class="remberme flex judtify-between item-center">
            ...
            <a href="login.php" class="p-2 text-blue-600">login Now?</a>
            </div>
        </div>
